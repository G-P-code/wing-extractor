...
WING Multichannel Tracks Extractor — extracts individual WAV tracks from Behringer WING console SD card recordings on macOS. Supports named tracks, stereo pairs, multi-chunk recordings.
